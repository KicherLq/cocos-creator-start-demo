          ...
          switch (input.type) {
            ...
            case (_crd && InputTypeEnum === void 0 ? (_reportPossibleCrUseOfInputTypeEnum({
            ...
            }), InputTypeEnum) : InputTypeEnum).TimePast:
              {
                ...
                for (var _bullet of bullets) {
                  _bullet.position.x += _bullet.direction.x * dt * BULLET_SPEED;
                  _bullet.position.y += _bullet.direction.y * dt * BULLET_SPEED;
                }
...
//# sourceMappingURL=bf618e4a393d197deb7a598678bc25fdd9bef66b.js.map