System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      NetWorkManager = _unresolved_10.NetWorkManager;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("BattleManager", BattleManager = (_dec = ccclass('BattleManager'), _dec(_class = class BattleManager extends Component {
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield _this.connectServer();
            (_crd && NetWorkManager === void 0 ? (_reportPossibleCrUseOfNetWorkManager({
              error: Error()
            }), NetWorkManager) : NetWorkManager).Instance.sendMessage('hello, here is client.');
          })();
        }
        ...
        connectServer() {
          ...
          return _asyncToGenerator(function* () {
            var e = yield (_crd && NetWorkManager === void 0 ? (_reportPossibleCrUseOfNetWorkManager({
              error: Error()
            }), NetWorkManager) : NetWorkManager).Instance.connect().catch(() => false);

            if (e !== false) {
              yield new Promise(rs => setTimeout(rs, 1000));
              yield _this2.connectServer();
            }
          })();
        }
        ...
        renderBullet() {
          for (var data of (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            ...
            if (!bm) {
              var bullet = (_crd && ObjectPoolManager === void 0 ? (_reportPossibleCrUseOfObjectPoolManager({
                error: Error()
...
//# sourceMappingURL=2f90e5cb45e87ade38fad2c6308b6f0bcfeb7df5.js.map