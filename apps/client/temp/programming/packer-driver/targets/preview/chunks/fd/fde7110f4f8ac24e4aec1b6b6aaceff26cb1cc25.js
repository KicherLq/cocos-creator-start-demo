System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, DataManager, EntityTypeEnum, InputTypeEnum, EntityManager, ActorStateMachine, EntityStateEnum, instantiate, WeaponManager, rad2Angle, _dec, _class, _crd, ccclass, property, ActorManager;
    ...
    execute: function () {
      ...
      _export("ActorManager", ActorManager = (_dec = ccclass('ActorManager'), _dec(_class = class ActorManager extends (_crd && EntityManager === void 0 ? (_reportPossibleCrUseOfEntityManager({
        ...
        render(data) {
          ...
          var rad = Math.asin(direction.y / side);
          var angle = (_crd && rad2Angle === void 0 ? (_reportPossibleCrUseOfrad2Angle({
            error: Error()
          }), rad2Angle) : rad2Angle)(rad); // this.__wm.node.setRotationFromEuler(0, 0, angle);
        }
...
//# sourceMappingURL=fde7110f4f8ac24e4aec1b6b6aaceff26cb1cc25.js.map