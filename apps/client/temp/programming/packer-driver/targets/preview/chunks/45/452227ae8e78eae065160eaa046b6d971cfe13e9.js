        ...
        renderBullet() {
          for (var data of (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            ...
            if (!am) {
              ...
              var _am2 = actor.addComponent(_crd && ActorManager === void 0 ? (_reportPossibleCrUseOfActorManager({
                error: Error()
              }), ActorManager) : ActorManager);

              (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
                error: Error()
              }), DataManager) : DataManager).Instance.actorMap.set(data.id, _am2);
...
//# sourceMappingURL=452227ae8e78eae065160eaa046b6d971cfe13e9.js.map