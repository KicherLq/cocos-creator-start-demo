System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, AnimationClip, State, StateMachine, getInitParamsTrigger, EntityStateEnum, ParamsNameEnum, ObjectPoolManager, _dec, _class, _crd, ccclass, ExplosionStateMachine;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ObjectPoolManager = _unresolved_5.ObjectPoolManager;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "04a73yEDphKZr+e8kPeg+hY", "ExplosionStateMachine", undefined);
      ...
      _export("ExplosionStateMachine", ExplosionStateMachine = (_dec = ccclass("ExplosionStateMachine"), _dec(_class = class ExplosionStateMachine extends (_crd && StateMachine === void 0 ? (_reportPossibleCrUseOfStateMachine({
        error: Error()
        ...
        initStateMachines() {
          this.stateMachines.set((_crd && ParamsNameEnum === void 0 ? (_reportPossibleCrUseOfParamsNameEnum({
            ...
            error: Error()
          }), EntityStateEnum) : EntityStateEnum).Idle, AnimationClip.WrapMode.Normal));
        }
...
//# sourceMappingURL=ff5fc3998874fa92975a18b68fb209b79affe11d.js.map