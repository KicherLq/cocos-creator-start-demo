    ...
    execute: function () {
      ...
      _export("BulletManager", BulletManager = (_dec = ccclass('BulletManager'), _dec(_class = class BulletManager extends (_crd && EntityManager === void 0 ? (_reportPossibleCrUseOfEntityManager({
        ...
        handleExplosionBorn(id, _ref) {
          ...
          var explosion = (_crd && ObjectPoolManager === void 0 ? (_reportPossibleCrUseOfObjectPoolManager({
            error: Error()
          ...
          var em = explosion.getComponent(_crd && ExplosionManager === void 0 ? (_reportPossibleCrUseOfExplosionManager({
            error: Error()
...
//# sourceMappingURL=a7e219a733682088c09416f1fb26ceab637d3af8.js.map