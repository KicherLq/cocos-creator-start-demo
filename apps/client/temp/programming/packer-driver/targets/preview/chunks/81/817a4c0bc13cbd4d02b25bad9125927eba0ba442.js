  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", State = class State {
        constructor(fsm, path, wrapMode, force) {
          if (wrapMode === void 0) {
          ...
          var spriteFrames = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
...
//# sourceMappingURL=817a4c0bc13cbd4d02b25bad9125927eba0ba442.js.map