System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, DataManager, EntityTypeEnum, InputTypeEnum, EntityManager, ActorStateMachine, EntityStateEnum, instantiate, WeaponManager, _dec, _class, _crd, ccclass, property, ActorManager;
    ...
    execute: function () {
      ...
      _export("ActorManager", ActorManager = (_dec = ccclass('ActorManager'), _dec(_class = class ActorManager extends (_crd && EntityManager === void 0 ? (_reportPossibleCrUseOfEntityManager({
        ...
        init(data) {
          ...
          const wm = weapon.addComponent(_crd && WeaponManager === void 0 ? (_reportPossibleCrUseOfWeaponManager({
            error: Error()
...
//# sourceMappingURL=b7b41a6621f4b721ae2461d4c21f2d0b5cda42a5.js.map