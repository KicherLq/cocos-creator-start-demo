System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, AnimationClip, State, StateMachine, getInitParamsTrigger, EntityStateEnum, ParamsNameEnum, _dec, _class, _crd, ccclass, ActorStateMachine;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "69b0fA3MHtEkbQuC4I87bpC", "ActorStateMachine", undefined);
      ...
      _export("ActorStateMachine", ActorStateMachine = (_dec = ccclass("ActorStateMachine"), _dec(_class = class ActorStateMachine extends (_crd && StateMachine === void 0 ? (_reportPossibleCrUseOfStateMachine({
        error: Error()
        ...
        initParams() {
          ...
          this.params.set((_crd && ParamsNameEnum === void 0 ? (_reportPossibleCrUseOfParamsNameEnum({
            error: Error()
          }), ParamsNameEnum) : ParamsNameEnum).Run, (_crd && getInitParamsTrigger === void 0 ? (_reportPossibleCrUseOfgetInitParamsTrigger({
            error: Error()
          }), getInitParamsTrigger) : getInitParamsTrigger)());
        }
        ...
        initStateMachines() {
          ...
          this.stateMachines.set((_crd && ParamsNameEnum === void 0 ? (_reportPossibleCrUseOfParamsNameEnum({
            error: Error()
          }), ParamsNameEnum) : ParamsNameEnum).Run, new (_crd && State === void 0 ? (_reportPossibleCrUseOfState({
            error: Error()
          }), State) : State)(this, `${this.type}${(_crd && EntityStateEnum === void 0 ? (_reportPossibleCrUseOfEntityStateEnum({
            error: Error()
          }), EntityStateEnum) : EntityStateEnum).Run}`, AnimationClip.WrapMode.Loop));
        }
...
//# sourceMappingURL=1f4b985769a5181229ab0a98cb5d26d16d7942e7.js.map