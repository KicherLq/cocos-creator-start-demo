  ...
  return {
    ...
    execute: function () {
      ...
      _export("JoyStickManager", JoyStickManager = (_dec = ccclass('JoyStickManager'), _dec(_class = class JoyStickManager extends Component {
        ...
        onTouchMove(event) {
          const touchPos = event.getUILocation();
          const relativePos = new Vec2(this._body.position.x - touchPos.x, this._body.position.y - touchPos.y);
        ...
        onTouchEnd() {
          ...
          this._stick.setPosition(this._defaultPos.x, this._defaultPos.y);
        }
...
//# sourceMappingURL=f0d167a42f3d827d4b66059fcc986adfedc4e223.js.map