  ...
  return {
    ...
    execute: function () {
      ...
      _export("WeaponManager", WeaponManager = (_dec = ccclass('WeaponManager'), _dec(_class = class WeaponManager extends (_crd && EntityManager === void 0 ? (_reportPossibleCrUseOfEntityManager({
        ...
        handleWeaponShot() {
          if (this.__owner !== (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          }), DataManager) : DataManager).Instance.myPlayerId) {
            return;
          }
...
//# sourceMappingURL=c0f9370e1a7f241e956299d287ccd169215f1c22.js.map