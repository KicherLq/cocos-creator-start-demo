System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, AnimationClip, State, StateMachine, getInitParamsTrigger, EntityStateEnum, ParamsNameEnum, WeaponManager, _dec, _class, _crd, ccclass, WeaponStateMachine;
  ...
  function _reportPossibleCrUseOfWeaponManager(extras) {
    _reporterNs.report("WeaponManager", "./WeaponManager", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      WeaponManager = _unresolved_5.WeaponManager;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "6ee0b0A8F1H0bYZv9DM2hwL", "WeaponStateMachine", undefined);
      ...
      _export("WeaponStateMachine", WeaponStateMachine = (_dec = ccclass("WeaponStateMachine"), _dec(_class = class WeaponStateMachine extends (_crd && StateMachine === void 0 ? (_reportPossibleCrUseOfStateMachine({
        ...
        initParams() {
          ...
          this.params.set((_crd && ParamsNameEnum === void 0 ? (_reportPossibleCrUseOfParamsNameEnum({
            error: Error()
          }), ParamsNameEnum) : ParamsNameEnum).Attack, (_crd && getInitParamsTrigger === void 0 ? (_reportPossibleCrUseOfgetInitParamsTrigger({
            error: Error()
          }), getInitParamsTrigger) : getInitParamsTrigger)());
        }
        ...
        initStateMachines() {
          this.stateMachines.set((_crd && ParamsNameEnum === void 0 ? (_reportPossibleCrUseOfParamsNameEnum({
            ...
            error: Error()
          }), EntityStateEnum) : EntityStateEnum).Idle}`, AnimationClip.WrapMode.Loop, true));
          this.stateMachines.set((_crd && ParamsNameEnum === void 0 ? (_reportPossibleCrUseOfParamsNameEnum({
            error: Error()
          }), ParamsNameEnum) : ParamsNameEnum).Attack, new (_crd && State === void 0 ? (_reportPossibleCrUseOfState({
            error: Error()
          }), State) : State)(this, `${this.type}${(_crd && EntityStateEnum === void 0 ? (_reportPossibleCrUseOfEntityStateEnum({
            error: Error()
          }), EntityStateEnum) : EntityStateEnum).Attack}`, AnimationClip.WrapMode.Normal, true));
        }

        initAnimationEvent() {
          this.animationComponent.on(Animation.EventType.FINISHED, () => {
            if (this.animationComponent.defaultClip.name.includes((_crd && EntityStateEnum === void 0 ? (_reportPossibleCrUseOfEntityStateEnum({
              error: Error()
            }), EntityStateEnum) : EntityStateEnum).Attack)) {
              this.node.parent.getComponent(_crd && WeaponManager === void 0 ? (_reportPossibleCrUseOfWeaponManager({
                error: Error()
              }), WeaponManager) : WeaponManager).state = (_crd && EntityStateEnum === void 0 ? (_reportPossibleCrUseOfEntityStateEnum({
                error: Error()
...
//# sourceMappingURL=e37a9575c45da881a2df3657ea4ed61ccb5a94db.js.map