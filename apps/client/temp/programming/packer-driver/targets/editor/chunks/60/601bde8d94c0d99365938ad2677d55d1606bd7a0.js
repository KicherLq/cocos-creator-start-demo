System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, DataManager, InputTypeEnum, EntityManager, EntityStateEnum, WeaponStateMachine, UITransform, Vec2, _dec, _class, _crd, ccclass, property, WeaponManager;
      ...
      _export("WeaponManager", WeaponManager = (_dec = ccclass('WeaponManager'), _dec(_class = class WeaponManager extends (_crd && EntityManager === void 0 ? (_reportPossibleCrUseOfEntityManager({
        ...
        init(data) {
          ...
          this.state = (_crd && EntityStateEnum === void 0 ? (_reportPossibleCrUseOfEntityStateEnum({
            error: Error()
          }), EntityStateEnum) : EntityStateEnum).Idle; // EventManager.Instance.on(EventEnum.shot, this.handleWeaponShot, this);
        }

        onDestroy() {// EventManager.Instance.off(EventEnum.shot, this.handleWeaponShot, this);
        }

        handleWeaponShot() {
          const pointWorldPos = this.__point.getWorldPosition();

          const pointStagePos = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          ...
          const direction = new Vec2(pointWorldPos.x - anchorWorldPos.x, pointWorldPos.y - anchorWorldPos.y);
...
//# sourceMappingURL=601bde8d94c0d99365938ad2677d55d1606bd7a0.js.map